...
dimorphicSpeciesReference <- length(which(referenceRegions$type == "conservedExcludingmonomorphicSpecies"))
monomorphicSpeciesReference <- length(which(referenceRegions$type == "conservedExcludingdimorphicSpecies"))

percentElementsAcceleratedInMonomorphic <- monomorphicSpeciesAccelerated/dimorphicSpeciesReference
percentElementsAcceleratedInDimorphic <- dimorphicSpeciesAccelerated/monomorphicSpeciesReference
