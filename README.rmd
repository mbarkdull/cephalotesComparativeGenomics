...
We will also run OrthoFinder with a user-specific species tree, to improve accuracy. If possible, obtain one for your group of species, by doing something like trimming a larger, high-quality phylogeny from the group you're working with. If no phylogeny for your species exists,  
