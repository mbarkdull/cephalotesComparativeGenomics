...
Repetitive regions of the genome must be soft-masked prior to annotation. To do this, we must first predict/identify transposable element sequences in the genomes, which we will do with RepeatModeler2, implemented in the Bash script `./Scripts/handlingRepeats`. You can run this script with the command `./Scripts/handlingRepeats [path to file listing samples] [number of threads to use when possible]`