...
This can be done using the R script `./Scripts/aligningScaffolds.R`, which will select out homologous scaffolds across your reference and new genomes, align them, then recombine them by genome into individual, aligned genomes. This process is parallelized using the excellent R package `furrr`. 
